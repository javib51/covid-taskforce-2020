...
class PickupOnTheWayPicker extends StatefulWidget {
  @override
  State<PickupOnTheWayPicker> createState() => _PickupOnTheWayPickerState();
}

class _PickupOnTheWayPickerState extends State<PickupOnTheWayPicker> {
  @override
  void initState() {
    super.initState();
  }
